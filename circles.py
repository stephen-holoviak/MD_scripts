...
# Main program:
a=Circle(18.0170807846332295, 21.6044995313476278, 2.0)
b=Circle(16.6311514935075984, 19.2039995834201136, 2.0)
c=Circle(15.2452222023819637, 16.8034996354925994, 2.0)
d=Circle(13.8592929112563308, 14.4029996875650852, 2.0)
e=Circle(12.4733636201306979, 12.0024997396375710, 2.0)
f=Circle(11.0874343290050650,  9.6019997917100568, 2.0)

print(a.circle_intersect(b))
print(b.circle_intersect(c))
print(c.circle_intersect(d))
print(d.circle_intersect(e))
print(e.circle_intersect(f))